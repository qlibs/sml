...
#if not defined(SML2_DISABLE_STATIC_ASSERT_TESTS)
namespace SML_TEST {
template<auto V>
...
static_assert(([] {
  constexpr auto expect = [](const bool cond) { bool _[1]{true}; return _[not cond]; };
...
#endif // SML2_DISABLE_STATIC_ASSERT_TESTS
#endif // SML2
#endif // __cplusplus
